...
\unitlength=0.5mm
\begin{picture}(0,0)
\put(0,-80){\mbox{\begin{tikzpicture}
  \shade[top color=blue!5, bottom color=blue!75] (0,0) rectangle (50,5);
\end{tikzpicture}}}
\put(0,-400){\mbox{\begin{tikzpicture}
  \shade[top color=yellow!40, bottom color=yellow!1] (0,0) rectangle (50,16.9);
\end{tikzpicture}}}

\input{left.tex}
\input{right.tex}
\put(340,-335){\href{https://alevisdanse.github.io}{\includegraphics[height=160mm]{../static/images/logo-aldc-contour-noir.pdf}}}
\end{picture}
...
\put(-5,-550){\includegraphics[height=325mm]{../images/Fond-bois-CoopCot.jpg}}
%\put(5,-375){\includegraphics[width=120mm]{../images/groupededanseenligne-ombre.pdf}}
\put(10,-335){\href{https://alevisdanse.github.io}{\includegraphics[height=160mm]{../static/images/logo-aldc-contour-noir.pdf}}}
...
\put(350,-360){\includegraphics[width=300mm]{../images/groupededanseenligne-ombre.png}}
