...
\put(5,-375){\includegraphics[width=120mm]{../images/groupededanseenligne-ombre.pdf}}
\put(10,-220){\href{https://alevisdanse.github.io}{\includegraphics[height=100mm]{../static/images/logo-aldc-sans-contour.pdf}}}
\put(850,-150){\href{https://alevisdanse.github.io}{\includegraphics[height=60mm]{../static/images/logo-aldc-contour-noir.pdf}}}
%\put(180,-350){\href{https://alevisdanse.github.io}{\includegraphics[height=80mm]{../static/images/logo-aldc-sans-contour.pdf}}}
\put(250,-350){\includegraphics[width=300mm]{../images/groupededanseenligne-ombre.png}}
...
\draw[draw=none, postaction={decorate,decoration={text along path,text align=center,text color=yellow!20,text={Oui à Lé-, Vis-Saint-Nom, On y danse, On y danse}}}] (aa) to [bend right=-20]  (bb);
\draw[draw=none, postaction={decorate,decoration={text along path,text align=center,text={Oui à Lé-, Vis-Saint-Nom, On y danse, On y danse}}}] (a) to [bend right=-20]  (b);
\end{tikzpicture}}
\put(280,-450){\begin{tikzpicture}
\node (a) at (0,0){};
\node (b) at (36,0){};
\node (aa) at (0.15,-0.15){};
\node (bb) at (36.15,-0.15){};
\draw[draw=none, postaction={decorate,decoration={text along path,text align=center,text color=blue!20,text={Oui à Lé-, Vis-Saint-Nom, On y danse, tous en ligne}}}] (aa) to [out=20,in=-140]  (bb);
\draw[draw=none, postaction={decorate,decoration={text along path,text align=center,text={Oui à Lé-, Vis-Saint-Nom, On y danse, tous en ligne}}}] (a) to [out=20,in=-140]  (b);
\end{tikzpicture}}
\end{picture}
